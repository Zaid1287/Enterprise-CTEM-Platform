...
async function seedNewTenantData(tenantId: number): Promise<void> {
  try {
    ...
    await db.insert(securityToolsTable).values([
      ...
      { tenantId, name: "dnsx", description: "Fast and multi-purpose DNS toolkit for resolution and enumeration", githubUrl: "https://github.com/projectdiscovery/dnsx", category: "recon", installCommand: "go install github.com/projectdiscovery/dnsx/cmd/dnsx@latest", updateCommand: "go install github.com/projectdiscovery/dnsx/cmd/dnsx@latest", runCommand: "dnsx -d {target} -resp -a -cname -mx -json", outputFormat: "json", isActive: true },
      { tenantId, name: "katana", description: "Next-generation crawling and spidering framework", githubUrl: "https://github.com/projectdiscovery/katana", category: "web_recon", installCommand: "go install github.com/projectdiscovery/katana/cmd/katana@latest", updateCommand: "go install github.com/projectdiscovery/katana/cmd/katana@latest", runCommand: "katana -u {target} -d 3 -json", outputFormat: "json", isActive: true },
      { tenantId, name: "mapcidr", description: "CIDR manipulation and aggregation tool for IP range operations", githubUrl: "https://github.com/projectdiscovery/mapcidr", category: "recon", installCommand: "go install github.com/projectdiscovery/mapcidr/cmd/mapcidr@latest", updateCommand: "go install github.com/projectdiscovery/mapcidr/cmd/mapcidr@latest", runCommand: "mapcidr -cl {target} -aggregate", outputFormat: "text", isActive: true },
      { tenantId, name: "shuffledns", description: "DNS brute force and resolution using massdns as the backend", githubUrl: "https://github.com/projectdiscovery/shuffledns", category: "recon", installCommand: "go install github.com/projectdiscovery/shuffledns/cmd/shuffledns@latest", updateCommand: "go install github.com/projectdiscovery/shuffledns/cmd/shuffledns@latest", runCommand: "shuffledns -d {target} -w wordlist.txt -r resolvers.txt", outputFormat: "text", isActive: true },
      { tenantId, name: "asnmap", description: "Map ASN numbers to IP CIDR ranges for network reconnaissance", githubUrl: "https://github.com/projectdiscovery/asnmap", category: "recon", installCommand: "go install github.com/projectdiscovery/asnmap/cmd/asnmap@latest", updateCommand: "go install github.com/projectdiscovery/asnmap/cmd/asnmap@latest", runCommand: "asnmap -a {target} -json", outputFormat: "json", isActive: true },
      { tenantId, name: "cdncheck", description: "Detect CDN, WAF, and cloud provider for given IP addresses", githubUrl: "https://github.com/projectdiscovery/cdncheck", category: "recon", installCommand: "go install github.com/projectdiscovery/cdncheck/cmd/cdncheck@latest", updateCommand: "go install github.com/projectdiscovery/cdncheck/cmd/cdncheck@latest", runCommand: "cdncheck -i {target} -json", outputFormat: "json", isActive: true },
      { tenantId, name: "uncover", description: "Quickly discover exposed hosts using Shodan, Fofa, Censys, and more", githubUrl: "https://github.com/projectdiscovery/uncover", category: "recon", installCommand: "go install github.com/projectdiscovery/uncover/cmd/uncover@latest", updateCommand: "go install github.com/projectdiscovery/uncover/cmd/uncover@latest", runCommand: "uncover -q \"{target}\" -e shodan,censys,fofa -json", outputFormat: "json", isActive: true },
      { tenantId, name: "tldfinder", description: "Find all top-level domains associated with an organization", githubUrl: "https://github.com/projectdiscovery/tldfinder", category: "recon", installCommand: "go install github.com/projectdiscovery/tldfinder/cmd/tldfinder@latest", updateCommand: "go install github.com/projectdiscovery/tldfinder/cmd/tldfinder@latest", runCommand: "tldfinder -d {target}", outputFormat: "text", isActive: true },
      { tenantId, name: "useragent", description: "Browser user agent parsing and random generation for reconnaissance", githubUrl: "https://github.com/projectdiscovery/useragent", category: "web_recon", installCommand: "go install github.com/projectdiscovery/useragent/cmd/useragent@latest", updateCommand: "go install github.com/projectdiscovery/useragent/cmd/useragent@latest", runCommand: "useragent --count 10", outputFormat: "json", isActive: true },
      { tenantId, name: "aix", description: "AI-powered LLM integration for automated security reconnaissance workflows", githubUrl: "https://github.com/projectdiscovery/aix", category: "osint", installCommand: "go install github.com/projectdiscovery/aix/cmd/aix@latest", updateCommand: "go install github.com/projectdiscovery/aix/cmd/aix@latest", runCommand: "aix -p \"Enumerate attack surface of {target}\"", outputFormat: "text", isActive: true },
      { tenantId, name: "vulnx", description: "Intelligent bot auto shell injector and CMS vulnerability scanner", githubUrl: "https://github.com/anouarbensaad/vulnx", category: "vuln_scan", installCommand: "git clone https://github.com/anouarbensaad/vulnx && pip3 install -r vulnx/requirements.txt", updateCommand: "git -C vulnx pull origin master", runCommand: "python3 vulnx.py -u {target} --dork cms", outputFormat: "text", isActive: true },
      { tenantId, name: "goleak", description: "Goroutine leak detector for Go programs — catches resource leaks in tests", githubUrl: "https://github.com/uber-go/goleak", category: "vuln_scan", installCommand: "go get go.uber.org/goleak", updateCommand: "go get go.uber.org/goleak@latest", runCommand: "go test -run TestMain ./... -count=1", outputFormat: "text", isActive: true },
    ]);
